...
const Menu = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_material.Paper, {
    ...
    variant: "subtitle1"
  }, endDate ? (0, _dateFns.format)(endDate, "MMMM DD, YYYY") : "End Date"))), /*#__PURE__*/_react.default.createElement(_material.Divider, null), /*#__PURE__*/_react.default.createElement(_material.Grid, {
    container: true,
    direction: "row",
    justifyContent: "center",
    wrap: "nowrap"
  ...
  })))), ranges.length > 0 ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("div", {
    className: classes.divider
